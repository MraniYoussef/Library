...
public class BibliothequeApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception  {
		...
		BookReservationStatus brs1=null;
		  ...
		  Employee A1= userRepository.save(new Employee("Abdellah", "Abdellah", "1234",
		  "A1", "Abdellah@gmail.com")); Member M1= userRepository.save(new
		  Member("yassine","yassine","123","y1","yassine@gmail.com,","menzeh", new
		  Date(), mf1.STUDENT ));
		  
		  Subscription sb1 = subscriptionRepository.save(new Subscription(M1,1,false));
		  Book b1 = bookRepository.save(new Book("aut1", "Illusions", bt1.ROMAN, 200,
		  20)); BookReservation br1= bookReservationRepository.save(new
		  BookReservation(M1, new Date(), brs1.VALIDATED, new Date(), b1 ));
